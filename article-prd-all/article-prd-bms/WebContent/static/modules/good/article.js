...
$(function () {
    ...
    getDataList = function () {
        $.ajaxGetData({
            "ajaxUrl": g_requestContextPath + "/goods/getArticleList",
            "fnData": fnData,
            "postData": {},
            "headtype": 1
        });
        ...
        submitHandler: function () {
            ...
            var options = {
                success: function (data) {
                    if (data.code == '1000') {
                        window.location.href = g_requestContextPath + "/goods/article";
                    } else {
...
//操作
function op(articleId) {
    return '<a class="a_style" data-id="' + articleId + '" onclick="deleteFile(this)">删除</a> ';
}
...
function deleteFile(obj) {
    var d = dialog({
        ...
        ok: function () {
            $.ajax({
                url: g_requestContextPath + '/goods/delArticle',
                data: {
